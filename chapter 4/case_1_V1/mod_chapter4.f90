module case1
  ...
  implicit none
  private
  public :: WP, stdout, write_con, micro_ch_pre, free_energ_ch, &
  ...
  real(WP), parameter, public :: dx = 1.0_WP !< x方向上相邻节点的距离为1mm
  real(WP), parameter, public :: dy = 1.0_WP !< y方向上相邻节点的距离为1mm
